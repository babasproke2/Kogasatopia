...
#define SMEXT_CONF_DESCRIPTION     "Overrides TF2 sentry target acquisition range from SourceMod ConVars."
...
/** Exposes this extension's main interface to SourceMod. */
