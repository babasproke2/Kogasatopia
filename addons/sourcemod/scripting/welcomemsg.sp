...
static const char g_SoldierReverts[][] = {
    ...
    "{default}Righteous Bison:{green} Original hitbox size, fires 45% faster, ignores bullet resists\n",
...
static const char g_EngineerReverts[][] = {
    "\x01Pomson:\x04 Original hitbox size, penetrates targets, ignores bullet resists\n",
