...
public void OnPluginStart() {
	...
	cvarEnabled = CreateConVar("sm_quickbuild_enable", "0", "Enables/disables engineer quick build");
	...
	cvarDisableTeleCollision = CreateConVar("qb_disabletelecollision", "0", "Prevents other players from colliding with teles");
