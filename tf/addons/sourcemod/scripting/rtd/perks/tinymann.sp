...
public void TinyMann_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		TinyMann_ApplyPerk(client, perk);
	}
	else
	{
		TinyMann_RemovePerk(client, reason);
	}
}
