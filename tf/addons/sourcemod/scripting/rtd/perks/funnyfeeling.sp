...
public void FunnyFeeling_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		FunnyFeeling_ApplyPerk(client, perk);
	}
	else
	{
		FunnyFeeling_RemovePerk(client, reason);
	}
}
