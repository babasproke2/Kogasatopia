...
public void OverhealBonus_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		OverhealBonus_ApplyPerk(client, perk);
	}
	else
	{
		OverhealBonus_RemovePerk(client, reason);
	}
}
