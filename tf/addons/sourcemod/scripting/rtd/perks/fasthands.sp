...
public void FastHands_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		FastHands_ApplyPerk(client, perk);
	}
	else
	{
		FastHands_RemovePerk(client, reason);
	}
}
