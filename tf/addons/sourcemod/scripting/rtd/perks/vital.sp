...
*/
public void Vital_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Vital_ApplyPerk(client, perk);
	}
	else
	{
		Vital_RemovePerk(client, reason);
	}
}
