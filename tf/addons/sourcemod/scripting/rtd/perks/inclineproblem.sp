...
public void InclineProblem_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		InclineProblem_ApplyPerk(client, perk);
	}
	else
	{
		InclineProblem_RemovePerk(client, reason);
	}
}
