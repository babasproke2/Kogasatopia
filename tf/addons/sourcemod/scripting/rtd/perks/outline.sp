...
public void Outline_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Outline_ApplyPerk(client, perk);
	}
	else
	{
		Outline_RemovePerk(client, reason);
	}
}
