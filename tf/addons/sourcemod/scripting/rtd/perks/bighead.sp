...
public void BigHead_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		BigHead_ApplyPerk(client, perk);
	}
	else
	{
		BigHead_RemovePerk(client, reason);
	}
}
