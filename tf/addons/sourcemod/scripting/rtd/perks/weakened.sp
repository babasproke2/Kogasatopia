...
public void Weakened_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Weakened_ApplyPerk(client, perk);
	}
	else
	{
		Weakened_RemovePerk(client, reason);
	}
}
