...
public void LongMelee_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		LongMelee_ApplyPerk(client, perk);
	}
	else
	{
		LongMelee_RemovePerk(client, reason);
	}
}
