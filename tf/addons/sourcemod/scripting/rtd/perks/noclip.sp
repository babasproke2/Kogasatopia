...
public void Noclip_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Noclip_ApplyPerk(client, perk);
	}
	else
	{
		Noclip_RemovePerk(client, reason);
	}
}
