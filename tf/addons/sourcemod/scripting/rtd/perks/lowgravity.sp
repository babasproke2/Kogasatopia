...
public void LowGravity_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		LowGravity_ApplyPerk(client, perk);
	}
	else
	{
		LowGravity_RemovePerk(client, reason);
	}
}
