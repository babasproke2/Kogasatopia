...
public void Blind_Call(const int client, const Perk perk, const bool apply, const RTDRemoveReason reason)
{
	if (apply)
	{
		Blind_ApplyPerk(client, perk);
	}
	else
	{
		Blind_RemovePerk(client, reason);
	}
}
