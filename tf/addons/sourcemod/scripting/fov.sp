...
public void OnPluginStart()
{
	...
	sv_fov_min = CreateConVar( "sv_fov_min", "20.0", "Minimum FOV", FCVAR_NOTIFY, true, 10.0, true, 998.0 );
	sv_fov_min.AddChangeHook( ConVar_FOV_MinMax );

	sv_fov_max = CreateConVar( "sv_fov_max", "160.0", "Maximum FOV", FCVAR_NOTIFY, true, 11.0, true, 999.0 );
